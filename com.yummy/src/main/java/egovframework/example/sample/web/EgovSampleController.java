...
public class EgovSampleController {
  ...
  public String updateSample(@ModelAttribute("searchVO") SampleDefaultVO searchVO,
  ...
  public String deleteSample(SampleVO sampleVO,
      @ModelAttribute("searchVO") SampleDefaultVO searchVO, SessionStatus status) throws Exception {
